...
export default function ActionBubble({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Popup Menu */}
      {isMenuOpen && (
        <div className="absolute bottom-16 right-0 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 p-2 mb-2 min-w-[140px]">
          <button
            onClick={() => {
              onChatClick();
              onToggleMenu();
